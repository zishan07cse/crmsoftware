...
@section('content')
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('/') }}/user/realestate/customer/statusubmit"
                ...
                <div class="col-md-12 grid-margin stretch-card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-success mr-2" data-toggle="modal"
                                    data-target="#modal-updatecalllist" data-whatever="@getbootstrap">Update</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 sm-screen-mb">
                                    ...
                                    <input type="text" class="form-control" name="cityname" id="cityname"
                                        value="@php echo $customerchoiceinfo[0]['cityname'] @endphp" disabled />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3 sm-screen-mb">
                                    ...
                                    <input type="text" class="form-control" name="areaname" id="areaname"
                                        ...
                                        placeholder="Area name" disabled>
                                </div>
                                <div class="col-sm-3 sm-screen-mb">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 sm-screen-mb">
                                    ...
                                    <input type="text" class="form-control"
                                        ...
                                        name="totalbudget" id="totalbudget" placeholder="Budget" disabled />
                                </div>
        ...
        <div class="modal-dialog modal-lg" style="margin-top:30px;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" onclick="closebasicmodal();">
    ...
    <div class="modal fade" id="modal-updatechoice" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
        ...
        <div class="modal-body">
            <form class="forms-sample" action="{{ url('/') }}/user/realestate/customer/propertychoiceinfoupdate"
                method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <div class="col-sm-3 sm-screen-mb">
            ...
            <div class="modal fade" id="modal-email" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/') }}/user/realestate/customer/statussubmit" method="POST"
                                enctype="multipart/form-data">
                                <div class="form-group">
