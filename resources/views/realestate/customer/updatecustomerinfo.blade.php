...
<script>
    ...
    $(function() {
        $("#siteviewdatepickerupdate").datepicker();
...
@section('content')
            ...
            <div class="page-header">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h3 class="page-title">
                                Customer Leads Information Updates
                            </h3>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <button type="submit" class="btn btn-success mr-2" data-toggle="modal"
                                        data-target="#modal-siteview" data-whatever="@getbootstrap">
                                        Site View
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success mr-2" data-toggle="modal"
                                            data-target="#modal-updateinterest"
                                ...
                                <div class="col-md-5">
                                    <div class="form-group row" style="margin-bottom:0px;">
                                        <h4 class="card-title mt-4">Contact with Customer:</h4>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3 sm-screen-mb">
                                ...
                                <input type="text" class="form-control"
                                    value="@php echo $customerchoiceinfo[0]['totalbudget'] @endphp" name="totalbudget"
                ...
                <div class="card">
                    <div class="card-body">
                        @php
                            $i = 0;
                        @endphp
                        <h4 class="card-title mt-4">Customer Siteview Information</h4>
                        <table id="customersiteviewlist" class="display" style="width:100%" class="table">
                            <thead>
                                <tr>
                                    <th>Sl.</th>
                                    <th>Date</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($customersiteviewinfo as $siteview)
                                    <tr>
                                        <td>{{ ++$i }}</td>
                                        <td> {{ $siteview->siteview_date }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <div class="modal fade" id="modal-siteview" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Site View</h5>
                    <button type="button" class="close" onclick="closemodal();">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="forms-sample" action="{{ url('/') }}/user/realestate/customer/siteviewsubmit"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <input id="type" type="hidden" class="form-control" name="customerid"
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 sm-screen-mb">
                                <label>Select Siteview Date:</label>
                                <input class="form-control" id="siteviewdatepickerupdate"
                                    name="siteviewdatepickerupdate" />
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#customersiteviewlist').DataTable({
            "sScrollX": "100%"
        });
    });
